...
public class lProdutcs extends JFrame {
    ...
    lProdutcs() {
        ...
        // Title
        label1 = new JLabel();
        label1.setText("Which Product Would You");
        label1.setBounds(430, 25, 500, 50);
        label1.setFont(f1);
        c.add(label1);

        label1 = new JLabel();
        label1.setText("Like to Buy?");
        label1.setBounds(430, 60, 500, 50);
        label1.setFont(f1);
        c.add(label1);

        // Country JButtons
        place1 = new JRadioButton("Smart Phone");
        ...
        place2 = new JRadioButton("Refrigerator");
        ...
        place3 = new JRadioButton("Microwave");
        ...
        place4 = new JRadioButton("Television");
        ...
        place5 = new JRadioButton("Laptop");
        ...
        btn3.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                if (place == 1) {
                    ...
                    JOptionPane.showMessageDialog(null, "Please select Product.", "Warning!!!",
