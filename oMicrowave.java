...
public class oMicrowave extends JFrame {
    ...
    oMicrowave() {
        ...
        // Pack 1 Details
        pack1 = new JRadioButton("Samsung MS23K3513AK/D2");
        ...
        // Pack 2 Details
        pack2 = new JRadioButton("LG MC28H5025VK/D2");
        ...
        label3 = new JLabel();
        label3.setText("Convection cooking");
        label3.setBounds(610, 150, 500, 50);
        label3.setFont(f4);
        c.add(label3);

        label3 = new JLabel();
        label3.setText("28 Liter capacity");
        ...
        label3 = new JLabel();
        label3.setText("Multi-cooking modes");
    ...
    public static void main(String[] args) {
        ...
        oMicrowave frame = new oMicrowave();
        frame.setVisible(true);
    }
}
