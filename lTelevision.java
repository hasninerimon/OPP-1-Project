...
public class lTelevision extends JFrame {
    ...
    lTelevision() {
        ...
        // Title
        label1 = new JLabel();
        label1.setText("3 Models Available for Television");
        label1.setBounds(430, 35, 600, 50);
        label1.setFont(f1);
        c.add(label1);

        label2 = new JLabel();
        label2.setText("Product! Select One : ");
        label2.setBounds(430, 70, 500, 50);
        label2.setFont(f1);
        c.add(label2);

        // Model 1 Details
        pack1 = new JRadioButton("Walton");
        ...
        label3 = new JLabel();
        label3.setText("Decent picture");
        label3.setBounds(430, 210, 520, 50);
        label3.setFont(f4);
        c.add(label3);

        label3 = new JLabel();
        label3.setText("Basic smart features");
        ...
        label3 = new JLabel();
        label3.setText("Modern design");
        label3.setBounds(610, 150, 500, 50);
        label3.setFont(f4);
        c.add(label3);

        label3 = new JLabel();
        label3.setText("Energy efficient");
        label3.setBounds(610, 180, 500, 50);
        label3.setFont(f4);
        c.add(label3);

        label3 = new JLabel();
        label3.setText("Eco-friendly operation");
        ...
        label3 = new JLabel();
        label3.setText("Low energy consumption");
        ...
        label3 = new JLabel();
        label3.setText("Variety of sizes");
    ...
    public static void main(String[] args) {
        ...
        lTelevision frame = new lTelevision();
        frame.setVisible(true);
    }
}
