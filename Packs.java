...
public class Packs extends JFrame {
    ...
    Packs() {
        ...
        defPacks = new JRadioButton("Stock Products");
        ...
        selfChosenPacks = new JRadioButton("Pre-Order");
        ...
        btn3.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                if (pack == 1) {
                    ...
                    JOptionPane.showMessageDialog(null, "You forgot to select Product type :(", "Warming!!!",
