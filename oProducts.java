...
public class oProducts extends JFrame {
    ...
    oProducts() {
        ...
        // Title
        label1 = new JLabel();
        label1.setText("Which Product Would");
        label1.setBounds(430, 25, 500, 50);
        label1.setFont(f1);
        c.add(label1);
        
        label1 = new JLabel();
        label1.setText("You Like to Purchase?");
        label1.setBounds(430, 60, 500, 50);
        label1.setFont(f1);
        c.add(label1);

        // Country JButtons
        country1 = new JRadioButton("Smart Phone");
        ...
        country2 = new JRadioButton("Refrigerator");
        ...
        country3 = new JRadioButton("Microwave");
        ...
        country4 = new JRadioButton("Television");
        ...
        country5 = new JRadioButton("Laptop");
        ...
        btn3.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                if (country == 1) {
                    ...
                    JOptionPane.showMessageDialog(null, "Please select Category.", "Warming!!!",
